...
public:
  ...
  void set_switch_power(SBHSwitch* sw) { switch_power_ = sw; }
  void set_switch_filter(SBHSwitch* sw) { switch_filter_ = sw; }
  void set_switch_bubble(SBHSwitch* sw) { switch_bubble_ = sw; }
